...
That said, ELA is just one of [_many_ tools](https://29a.ch/photo-forensics/#forensic-magnifier) that can be used in forensics. All of them require insight, experience, digital literacy, and an attention to detail in order to be at all worth with any merit or argument. If someone has a reason to doubt an image's authenticity, then the onus is on them to make a strong enough statement for that to be the case. Demonstrating one's own capacity for minimizing their own biases is just as necessary as bolstering an argument with enough evidence to do so. In an age where it's easier to profit off of lies, the ability to find authenticity in our social feeds is only getting harder over time. Taking a photo without AI filtering on iOS in 2024 is [very difficult](https://support.apple.com/guide/iphone/take-apple-proraw-photos-iphae1e882a3/ios). A tool like ELA Mate can still do a good job of discerning where filtering has occured in the present day, but AI filters are only getting better at hiding its traces by our very own pervasive and willful use every day. If digital literacy is increasingly downplayed for artificially made profits today, then what room will there be for reality in a future that's already fake?
